...
// If you already have a toast system, swap alert() calls for toast()
export default function SettingsPage() {
  ...
  async function onSaveProfile() {
    ...
    alert("Hook this up to your profile update endpoint.");
  }
  ...
  async function onExportData() {
    ...
    alert("Hook this up to export my data.");
  }
  ...
  async function onSignOut() {
    ...
    // await authSignOut()
    // navigate("/")
    alert("Hook this up to your sign-out function, then redirect to /.");
  }
  ...
  async function onDeleteAccount() {
    ...
    // await authSignOut()
    // navigate("/")
    alert("Hook this up to DELETE /api/v1/me, then sign out + redirect.");
  }
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-10">
      ...
      <Card className="rounded-2xl border-white/10 bg-white/5 text-white">
        ...
        <CardContent className="flex flex-col gap-3">
          <Button variant="destructive" className="rounded-xl" onClick={onDeleteAccount}>
            Delete account
          </Button>
